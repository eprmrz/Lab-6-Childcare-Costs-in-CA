...
ca_childcare <- ca_childcare %>%
  ...
  mutate(region = fct_collapse(county_name,
    'Northern California' = "Del Norte", "Humboldt", "Lake", "Mendocino", "Siskiyou", "Trinity",
    'Superior California' = "Butte", "Colusa", "Glenn", "Lassen", "Modoc", "Plumas", "Shasta", "Sutter", "Tehama", "Yuba",
    ...
    'San Diego' = "San Diego",
    'Sacramento Area' = "Placer", "Sacramento", "Yolo", "El Dorado"
  ))
